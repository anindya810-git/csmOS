...
const NAV_ITEMS = [
  ...
  { to: '/feature-requests', end: false, label: 'Feature Requests', short: 'Features', feature: 'feature_requests', d: 'M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18' },
          ...
          <div className="relative" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="absolute right-0 top-full mt-2 w-60 bg-white rounded-xl shadow-lg border border-gray-100 z-50 overflow-hidden">
                ...
                {/* Settings / Preferences — available to all users */}
                <Link
                  to="/settings"
                ...
                >
                  ...
                  {user?.role === 'admin' ? 'Settings' : 'My Preferences'}
                </Link>
