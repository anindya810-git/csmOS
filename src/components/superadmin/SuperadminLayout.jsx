...
export default function SuperadminLayout() {
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="px-4 py-5 border-b border-gray-800 flex items-center justify-between">
        ...
        <button onClick={closeSidebar} className="lg:hidden p-1 text-gray-500 hover:text-white transition">
      ...
      {/* Nav — clicking any link closes the sidebar on mobile */}
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto" onClick={closeSidebar}>
  ...
  return (
    <div className="min-h-screen bg-gray-950 lg:flex">
      ...
      {/* Mobile top bar */}
      <div className="lg:hidden sticky top-0 z-30 bg-gray-900 border-b border-gray-800 px-4 py-3 flex items-center gap-3">
        <button
        ...
        <p className="text-white text-sm font-bold">Cust<span className="text-brand-400">ally</span> <span className="text-gray-500 font-normal text-xs">Superadmin</span></p>
      </div>
      ...
      <aside className={`
        ...
        lg:relative lg:z-auto lg:w-56 lg:flex-shrink-0 lg:translate-x-0
